...
//Main plugin
const MODEL_PATH = 'sqrxr_105_graphopt/model.json'
...
function addToPredictionBuffer(prediction)
{
    ...
    if(predictionBuffer.length>50) {
        ...
        console.log("Estimated TP COUNT: "+estimatedTruePositiveCount);
...
function checkZone()
{
    ...
    if(estimatedTruePositivePercentage < 0.02) {
        requestedZone = 'trusted';
    } else if(estimatedTruePositivePercentage < 0.06) {
...
var neutralRoc = findROCEntryByFPR(0.04);
